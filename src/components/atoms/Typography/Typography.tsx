 ...
 */
export const H1: React.FC<TypographyProps> = (typographyProps: TypographyProps):
JSX.Element => renderText(typographyProps);
 ...
 */
export const H2: React.FC<TypographyProps> = (typographyProps: TypographyProps):
JSX.Element => renderText(typographyProps);
 ...
 */
export const H3: React.FC<TypographyProps> = (typographyProps: TypographyProps):
JSX.Element => renderText(typographyProps);
 ...
 */
export const H4: React.FC<TypographyProps> = (typographyProps: TypographyProps):
JSX.Element => renderText(typographyProps);
 ...
 */
export const H5: React.FC<TypographyProps> = (typographyProps: TypographyProps):
JSX.Element => renderText(typographyProps);
 ...
 */
export const Label: React.FC<TypographyProps> = (typographyProps: TypographyProps):
JSX.Element => renderText(typographyProps);
 ...
 */
export const P: React.FC<TypographyProps> = (typographyProps: TypographyProps):
JSX.Element => renderText(typographyProps);
